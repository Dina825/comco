...
class StockController extends Controller {
	...
	*/
	...
	public function viewstock($id=""){
		...
		return view('areamanager/viewstock', array('title' => 'Stock of Month', 'user_details' => $user_details, 'stocklist' => $stocklist, 'user_id' => $user_id));
	}
	public function viewstockdetails($id=""){
		...
		return view('areamanager/viewstockdetails', array('title' => 'Stock of Month', 'user_details' => $user_details, 'stock' => $stock));
	}
