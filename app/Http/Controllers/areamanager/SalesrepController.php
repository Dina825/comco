...
class SalesrepController extends Controller {
	...
	*/
	...
	public function salesrep()
	{
		...
		return view('areamanager/salesrep', array('title' => 'Manage Sales REP', 'user_id' => $user_id));
	}
	...
	public function filterforsalesrep(){
		...
		$userlist = DB::table('sales_rep')->whereIn('user_id', $userlistarea)->get();
	...
	public function timesheet($id=""){		
		...
		return view('areamanager/time_sheet', array('title' => 'Time Sheet', 'userdetails' => $user, 'user_id' => $user_id, 'date_current' => $current_date, 'today_href' => $today_href ));
	}
	...
	public function timesheetprevious($id=""){
		...
		return view('areamanager/time_sheet', array('title' => 'Time Sheet', 'userdetails' => $user, 'user_id' => $user_id, 'date_current' => $current_date, 'today_href' => $id ));
	}
	public function salesreplocation(){
		$user_id = Session::get("sales_id");
		$current_date = Input::get('id');

		$location_details = DB::table('sim_allocate')->where('sales_rep_id', $user_id)->where('date', $current_date)->groupBy('shop_id')->orderBy('time', 'asc')->get();
		...
		$location_return = DB::table('return_sim')->where('sales_rep_id', $user_id)->where('date', $current_date)->groupBy('shop_id')->orderBy('time', 'asc')->get();
