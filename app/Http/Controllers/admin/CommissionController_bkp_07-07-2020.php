...
class CommissionController extends Controller {
	...
	*/
	...
	public function chequedetails(){
		...
		if($type==3){
			echo json_encode(array('id' => base64_encode($details->paid_id), 'salesrep' => $details->salesrep, 'commission' => $details->commission));
		}
	...
	public function chequeupdate(){
		...
		return redirect::back()->with('message', 'Cheque was successfully updated');
	}
}
