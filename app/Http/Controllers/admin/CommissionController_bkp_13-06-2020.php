			...
			<table style="width:100%;border-collapse:collapse;margin-top:20px;'.$font_family.'">
				...
				if(count($networks))
				{
					...
					$output.='<tr>
						...
						$output.='<tr>
							<td colspan="5" style="font-weight:600;padding:6px;border:1px solid #000; text-align:center;'.$font_family.'">All commissions are inculsive of VAT</td>
