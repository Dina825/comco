	...
	*/
			...
			if($comm_cost_value >= $minimum_value)
			{
				foreach($networks as $key => $network)
				{
					...
					if($two_allotted[$key] != '0')
					{
						...
						$checkzero = $two_allotted[$key] * $two_array[$network];
						if($checkzero > 0)
						{
					...
					if($three_allotted[$key] != '0')
					{
						...
						$checkzero = $three_allotted[$key] * $three_array[$network];
						if($checkzero > 0)
						{
					...
					if($four_allotted[$key] != '0')
					{
						...
						$checkzero = $four_allotted[$key] * $four_array[$network];
						if($checkzero > 0)
						{
					...
					if($five_allotted[$key] != '0')
					{
						...
						$checkzero = $five_allotted[$key] * $five_array[$network];
						if($checkzero > 0)
						{
					...
					if($six_allotted[$key] != '0')
					{
						...
						$checkzero = $six_allotted[$key] * $six_array[$network];
						if($checkzero > 0)
						{
					...
					if($seven_allotted[$key] != '0')
					{
						...
						$checkzero = $seven_allotted[$key] * $seven_array[$network];
						if($checkzero > 0)
						{
					...
					if($eight_allotted[$key] != '0')
					{
						...
						$checkzero = $eight_allotted[$key] * $eight_array[$network];
						if($checkzero > 0)
						{
					...
					if($nine_allotted[$key] != '0')
					{
						...
						$checkzero = $nine_allotted[$key] * $nine_array[$network];
						if($checkzero > 0)
						{
					...
					if($ten_allotted[$key] != '0')
					{
						...
						$checkzero = $ten_allotted[$key] * $ten_array[$network];
						if($checkzero > 0)
						{
	...
	public function print_pdf_for_shop()
	{
		...
		$output = '<div style="width:100%;float:left;'.$font_family.'">
			<table align="center" style="width:95%; border-collapse:collapse;border:0px solid;'.$font_family.'">
				<tr>
					<td width="150px;" style="'.$font_family.'"><img src="'.URL::to('assets/images/comco_logo_red.png').'"></td>
					<td style="text-align:right;'.$font_family.'"><strong style="font-weight:800">Comco Group UK Ltd</strong><br/>
						...
						T: +44 (0) 20 3322 5259<br/>E:sales@comco-retail.co.uk
					</td>
				</tr>
				<tr>
					<td colspan="2" style="height:10px;'.$font_family.'">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2"  style="'.$font_family.'">
			...
			<table align="center" style="width:95%; font-size:15px; border-collapse:collapse;margin-top:20px;'.$font_family.'">
				<tr>
					<td rowspan="2" style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Network</td>
					<td colspan="3" style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Connections</td>
					<td colspan="2" style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Topups</td>
					<td rowspan="2" style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Grand<br/>Total(£)</td>
				</tr>
				<tr>
					<td style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">1st</td>
					<td style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Rate (£)</td>
					<td style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Total (£)</td>
					<td style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Total (2-10)</td>
					<td style="font-weight:600;padding:4px;border:1px solid #000; text-align:center;'.$font_family.'">Total (£)</td>
				</tr>';
				...
				if(count($networks))
				{
					foreach($networks as $network)
					{
						...
						$topups_count = DB::table('sim_processed')->where('shop_id',$shop_id)->where('month_year',$value)->where('network_id',$network->network_name)->where('topups_commission','!=','0')->where('proceed_count','1')->sum('topups');
						...
						if(count($first_count_query))
						{
							...
							if(count($get_plan_id))
							{
								...
								if (array_key_exists($network->network_name,$one_array))
								{
						...
						$output.='<tr>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">'.$network->name.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">'.$first_count.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$first_rate.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$first_commission_total.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">'.$topups_count.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$topups_commission_total.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$totalvalue.'</td>
						</tr>';
					}

					$output.='<tr>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">Sub Total</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">'.$sub_first_count.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'"></td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$sub_first_commission_total.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">'.$sub_topups_count.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$sub_topups_commission_total.'</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$subtotalvalue.'</td>
						</tr>
						';
						if($sub_carry_cost != 0){
							$output.='<tr>
								<td colspan="6" style="font-weight:600;padding:3px;border:1px solid #000; text-align:right;'.$font_family.'">Carry Forward</td>
								<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$sub_carry_cost.'</td>
							</tr>';
						}
						$subtotalvalue = $subtotalvalue + $sub_carry_cost;
						$output.='<tr>
							<td colspan="5" style="font-weight:600;padding:3px;border:1px solid #000; text-align:center;'.$font_family.'"></td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">Total</td>
							<td style="padding:3px;border:1px solid #000; text-align:center;'.$font_family.'">£ '.$subtotalvalue.'</td>
						</tr>';
				}
			$output.= '</table>

			<table style="width:100%;border-collapse:collapse;border:0px solid;margin-top:10px;'.$font_family.'">
				<tr>
	...
	public function releasecheque(){
		$shop_id = base64_decode(Input::get('shop_id'));

		$shop_details = DB::table('shop')->where('shop_id', $shop_id)->first();

		$description = 'Admin release cheque';

		$data['area'] = $shop_details->area_name;
		$data['route'] = $shop_details->route;
		$data['shop_id'] = $shop_id;
		$data['salesrep'] = Input::get('salesrep');		
		$data['description'] = $description;
		$data['commission'] = Input::get('amount');		
		$data['date'] = date('Y-m-d');
		$data['time'] = date('h:i');
		$data['type'] = '1';
		$data['cheque_number'] = Input::get('number');

		DB::table('commission_paid')->insert($data);
		return redirect::back()->with('message', 'Cheque was successfully released');
	}
	...
	public function chequedetails(){
		...
		if($type==3){
			echo json_encode(array('id' => base64_encode($details->paid_id), 'salesrep' => $details->salesrep, 'commission' => $details->commission, 'cheque_number' => $details->cheque_number));
		}
		if($type == 4){
			$shop_details = DB::table('shop')->where('shop_id', $details->shop_id)->first();
			$content = 'Are you sure want received cheque for '.$shop_details->shop_name.' commission of &#163; '.$details->commission.'?';
	...
	public function chequereceived(){
		$id = base64_decode(Input::get('id'));
		$data['status'] = '3';
		$data['return_received_date'] = date('Y-m-d');
		$data['return_received_time'] = date('h:i');
		DB::table('commission_paid')->where('paid_id', $id)->update($data);

		return redirect::back()->with('message', 'Cheque received status successfully updated');
	}
}
