    ...
    <div style="background:#fff; width:85%; overflow:hidden;text-align:left;padding:15px;max-width:600px;margin:30px auto 30px;display:block;">
        ...
        <div style="width:100%; float:left; height:auto; padding:20px;">
            <div style="width:100%; margin-bottom:15px;">
                <div style="width:100%;float:left;height:auto;padding:20px">
                    <div style="width:100%;margin-bottom:15px"> <b>Dear Admin</b><br> Congratulation! <?php echo $fname; ?> has successfully registered into your Villagers Homes. Please follow up with him to see if he is interested to add his property on our website. <br/>
                    <p>His Email address is: <?php echo $email; ?></p>
                    </div>
                    <div>
