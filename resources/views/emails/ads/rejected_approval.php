    ...
    <div style="background:#fff; width:85%; overflow:hidden;text-align:left;padding:15px;max-width:600px;margin:30px auto 30px;display:block;">
        ...
        <div style="width:100%; float:left; height:auto; padding:20px;">
            <div style="width:100%; margin-bottom:15px;">
                <div style="width:100%;float:left;height:auto;padding:20px">
                    <div style="width:100%;margin-bottom:15px"> <b>Dear <?php echo $fname; ?> <?php echo $lname; ?></b><br> Your banner ID Banner<?php echo $banner_id; ?> from Order No. <?php echo $order_id; ?> is rejected by Administrator as it's voileting terms & conditions of Village House<br> Please replace this banner with correct banner by logging into My Accounts page.</div>
