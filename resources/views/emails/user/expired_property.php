    ...
    <div style="background:#fff; width:85%; overflow:hidden;text-align:left;padding:15px;max-width:600px;margin:30px auto 30px;display:block;">
        ...
        <div style="width:100%; float:left; height:auto; padding:20px;">
            <div style="width:100%; margin-bottom:15px;">
                <div style="width:100%;float:left;height:auto;padding:20px">
                    <div style="width:100%;margin-bottom:15px"> <b>Dear <?php echo $fname; ?></b><br> This is to inform you to that your Property associated with the Property Name: <?php echo $property_name; ?>, has expired today and has been removed from the public display. To activate them please login to our Villagershomes as a user and renew your Property at your earliest convenience. </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div style="width:50%;height:auto;float:left">: <?php echo $property_address; ?></a></div>
                    </div>
