...
<div class="modal fade add_model" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm ">
    <div class="modal-content">
      <form method="post" action="<?php echo URL::to('admin/category_add')?>"  enctype="multipart/form-data" id="add-form">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">                    
      						<div class="form-group">
      						    ...
      						    <input type="text" class="form-control add_input" name="name" required placeholder="Enter Category Name">
      						</div>
      				  </div>                                      
            </div>                
      </div>
...
<div class="modal fade edit_model" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
  <div class="modal-dialog modal-sm ">
    <div class="modal-content">
      <form method="post" action="<?php echo URL::to('admin/category_update')?>"  enctype="multipart/form-data" id="edit-form">
       <div class="modal-header">
      ...
      <div class="modal-body">
            ...
            <div class="row">
            	<div class="col-lg-12 col-md-12 col-sm-12 col-12">                    
      						<div class="form-group">
      						    <label>Enter Category Name</label>
      						    <input type="text" class="form-control class_name" name="name" required placeholder="Enter Category Name">
      						</div>
      				</div>
            </div>                
      </div>
...
<div class="modal fade status_model" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="<?php echo URL::to('admin/category_status')?>">
                <div class="modal-header">
...
<div class="col-lg-11 col-md-12 col-sm-12 col-12 offset-lg-1 right_panel">
	<div class="row">
		<div class="col-lg-6 col-sm-6 col-6">
			<div class="main_title">Manage <span>Category</span></div>
		</div>
		<div class="col-lg-6 col-sm-6 col-6">
	...
	<div class="row">
		...
		<div class="col-lg-12 text-left">
			<a href="#" class="common_button float_right add_button_class" data-toggle="modal" data-target=".add_model">Add New Category</a>
		          	...
		          	if(count($category_list)){
		          		foreach ($category_list as $category) {
		          			if($category->status == 0){
		          				$status = '<a href="javascript:" data-toggle="tooltip" data-placement="top" data-original-title="Deactive" style="color: #33CC66"><i class="fas fa-check deactive_class" data-element="'.base64_encode($category->category_id).'"></i></a>';
		          			}
		          			else{
		          				$status = '<a href="javascript:" data-toggle="tooltip" data-placement="top" data-original-title="Active" style="color: #E11B1C"><i class="fas fa-times active_class" data-element="'.base64_encode($category->category_id).'"></i></a>';
		          			}
		          			$output.='
		          			<tr>
				          		<td>'.$i.'</td>
				          		...
				          		<td align="center">
				          		<a href="javascript:" data-toggle="tooltip" data-placement="top" data-original-title="Edit Category" ><i class="far fa-edit edit_icon" data-element="'.base64_encode($category->category_id).'"></i></a>&nbsp;&nbsp;&nbsp;				          		
				          		'.$status.'
				          		</td>
				          	</tr>
		          			';
...
if($(e.target).hasClass("active_class")){
  ...
  setTimeout(function() {
    ...
    $.ajax({
        url:"<?php echo URL::to('admin/category_details')?>",
        dataType:'json',
