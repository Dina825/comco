...
<table class='time_sheet_table' border=1>
  <tr>
    <th colspan="2" class="text-center"><a href="<?php echo URL::to('areamanager/time_sheet_previous/'.base64_encode($previous_month))?>">Previous</a></th>
    ...
    <th colspan="2" class="text-center">
      ...
      if($today_href != ''){
        $today = '<a href="'.URL::to('areamanager/time_sheet/'.base64_encode($userdetails->user_id)).'">Today</a>';
      }
      else{
        $today = '';
      }
...
if($(e.target).hasClass("location_class")){
    ...
    setTimeout(function() {
      ...
      $.ajax({
          url:"<?php echo URL::to('areamanager/sales_rep_location')?>",
          dataType:'json',
          data:{id:value},
          type:"post",
