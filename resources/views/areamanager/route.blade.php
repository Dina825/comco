...
<div class="modal fade add_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form id="add-form" method="post" action="<?php echo URL::to('areamanager/route_add')?>" enctype="multipart/form-data">
                <div class="modal-header">
...
<div class="modal fade edit_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form id="edit-form" method="post" action="<?php echo URL::to('areamanager/route_update')?>" enctype="multipart/form-data">
                <div class="modal-header">
...
<div class="modal fade status_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="<?php echo URL::to('areamanager/route_status')?>">
                <div class="modal-header">
...
if($(e.target).hasClass("active_class")){
    ...
    setTimeout(function() {
      $.ajax({
          url:"<?php echo URL::to('areamanager/route_details')?>",
          dataType:'json',
...
if($(e.target).hasClass("total_sim")){
  ...
  setTimeout(function() {
    ...
    var value = $(e.target).attr("data-element");
    $.ajax({
        url:"<?php echo URL::to('areamanager/total_sim_route')?>",
        dataType:'json',
        data:{id:value, type:3},
        type:"post",
        success: function(result)
...
if($(e.target).hasClass("active_sim")){
  ...
  setTimeout(function() {
    ...
    var value = $(e.target).attr("data-element");
    $.ajax({
        url:"<?php echo URL::to('areamanager/active_sim_route')?>",
        dataType:'json',
        data:{id:value, type:3},
        type:"post",
        success: function(result)
...
if($(e.target).hasClass("inactive_sim")){
  ...
  setTimeout(function() {
    ...
    var value = $(e.target).attr("data-element");
    $.ajax({
        url:"<?php echo URL::to('areamanager/inactive_sim_route')?>",
        dataType:'json',
        data:{id:value, type:3},
        type:"post",
        success: function(result)
...
if($(e.target).hasClass("refresh_icon")){
  ...
  var value = $(e.target).attr("data-element");
  $.ajax({
      url:"<?php echo URL::to('areamanager/refresh_route_icon')?>",
      dataType:'json',
      data:{id:value},
      type:"post",
      success: function(result)
...
if($(e.target).hasClass("select_area_class")){
  var id = $(e.target).val();
  $.ajax({
    url:"<?php echo URL::to('areamanager/route_select_rep')?>",
    dataType:'json',
    data:{id:id},
    type:"post",
    success: function(result)
...
if($(e.target).hasClass("filter_by_area")){
  ...
  setTimeout(function() { 
    $.ajax({
      url:"<?php echo URL::to('areamanager/filter_route')?>",
      dataType:'json',
      data:{id:id,type:1},
      type:"post",
      success: function(result)
...
if($(e.target).hasClass("select_edit_area_class")){
  ...
  $.ajax({
    url:"<?php echo URL::to('areamanager/route_select_rep_edit')?>",
    dataType:'json',
