...
@section('content')
<style type="text/css">
#carouselExampleIndicators .carousel-indicators{position: fixed; right: 0px; top: 150px;  margin:0px; width: 30px; bottom: unset; left: unset; display: unset; }
...
<div class="modal fade edit_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="post" action="<?php echo URL::to('areamanager/shop_update')?>" id="edit-form">
...
<div id="shop_commission" style="display: none;">
