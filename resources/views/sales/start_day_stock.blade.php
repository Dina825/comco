...
<!-- Content Header (Page header) -->
	...
	<div class="row">
		<div class="col-lg-12 col-sm-12 col-12">
			<div class="main_title">Start <span>Day Stock</span></div>
		</div>
	</div>
	<div class="row margin_top_20">
		...
		<div class="col-lg-6 col-md-8 col-sm-12 col-12">
			<form method="post" action="<?php echo URL::to('sales/add_start_day_stock')?>">
			...
			<div class="width_100 margin_top_20">
				...
				<button type="submit" class="btn btn-primary model_add_button" style="float: right;">Start</button>
			</div>
		</div>
		</form>			
