...
<div class="login_bg">
  <div class="login_center">
    <div class="logo img-responsive text-center"><img src="<?php echo URL::to('assets')?>/images/logo.png"></div>
     <form action="<?php echo URL::to('sales/login'); ?>" method="post">       
      <div class="main_title" style="font-weight: 300; text-align: center; margin:20px 0px 0px 0px; ">Welcome <span style="font-weight: 500;">Sales REP</span></div>
